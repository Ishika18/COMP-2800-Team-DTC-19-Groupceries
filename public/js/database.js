...
console.log(`
let item1 = {name: "cabbage", quantity:{amount: 5, unit:"heads"}, found: null, notes: "note"};
let item2 = {name: "beef", quantity:{amount: 3, unit:"kgs"}, found: null, notes: "note"};
let item3 = {name: "broth", quantity:{amount: 1, unit:"litres"}, found: null, notes: "note"};
let dinner = [item1, item2, item3];
let item4 = {name: "eggs", quantity:{amount: 2, unit:"dozen"}, found: null, notes: "note"};
let item5 = {name: "oatmeal", quantity:{amount: 2.5, unit:"kg"}, found: null, notes: "note"};
let item6 = {name: "whiskey", quantity:{amount: 1.14, unit:"litres"}, found: null, notes: "note"};
